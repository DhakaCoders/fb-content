...
function cbv_get_related_category_posts($taxno= 'product_cat', $perpage = 4)
{
    ...
    $categories = get_the_terms( $post_id, $taxno );
    //return $categories;
    ...
    $args = [
        ...
        'posts_per_page' => $perpage, // Note: showposts is depreciated in favor of posts_per_page
